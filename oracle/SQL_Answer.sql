...
-- 20000  12000  50000
select
  sum(decode ( to_char(order_date, 'MM'), '01', 1, 0 )) as m01,
  sum(decode ( to_char(order_date, 'MM'), '02', 1, 0 )) as m02,
  sum(decode ( to_char(order_date, 'MM'), '03', 1, 0 )) as m03,
  sum(decode ( to_char(order_date, 'MM'), '04', 1, 0 )) as m04,
  sum(decode ( to_char(order_date, 'MM'), '05', 1, 0 )) as m05,
  sum(decode ( to_char(order_date, 'MM'), '06', 1, 0 )) as m06,
  sum(decode ( to_char(order_date, 'MM'), '07', 1, 0 )) as m07,
  sum(decode ( to_char(order_date, 'MM'), '08', 1, 0 )) as m08,
  sum(decode ( to_char(order_date, 'MM'), '09', 1, 0 )) as m09,
  sum(decode ( to_char(order_date, 'MM'), '10', 1, 0 )) as m10,
  sum(decode ( to_char(order_date, 'MM'), '11', 1, 0 )) as m11,
  sum(decode ( to_char(order_date, 'MM'), '12', 1, 0 )) as m12
from orders;
